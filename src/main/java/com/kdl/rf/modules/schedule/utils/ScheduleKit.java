package com.kdl.rf.modules.schedule.utils;

import com.kdl.rf.common.exception.KvfException;
import com.kdl.rf.common.utils.SpringContextKit;
import com.kdl.rf.modules.schedule.constant.JobConstant;
import com.kdl.rf.modules.schedule.entity.Job;
import org.quartz.*;
...
public class ScheduleKit {
    ...
    public static void create(Long jobId, com.kdl.rf.modules.schedule.entity.Job job) {
        try {
            // 启动调度器
//            scheduler.start();
            //构建job信息
