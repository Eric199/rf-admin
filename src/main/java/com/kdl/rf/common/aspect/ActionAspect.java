package com.kdl.rf.common.aspect;
...
import com.kdl.rf.modules.sys.service.ILogService;
...
public class ActionAspect {
	...
	@Pointcut("@annotation(com.kdl.rf.common.annotation.Log)")
	...
	private void saveActionLog(JoinPoint joinPoint, long time, boolean isAround) {
		...
		com.kdl.rf.modules.sys.entity.Log actionLog = new com.kdl.rf.modules.sys.entity.Log();
		com.kdl.rf.common.annotation.Log action = method.getAnnotation(com.kdl.rf.common.annotation.Log.class);
		if(action != null){
			// 注解上的描述
