...
public class CodeGenerator {
    ...
    private static String packageName = "com.kdl.rf"; // 生成的包名
...
//                .setDbColumnUnderline(true)
                ...
                .setSuperEntityClass("com.kdl.rf.common.entity.BaseEntity")
                .setSuperControllerClass("com.kdl.rf.common.controller.BaseController");
